...
{
    public partial class TraineeID_Class : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TraineeType = table.Column<string>(nullable: false),
                    ...
                    NameOfCadre = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TraineesID", x => x.ID);
                });
        }
